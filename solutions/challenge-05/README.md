...
Ahora, para probar que somos capaces de crear un algoritmo que funcione, tenemos la lista de mecenas de la comunidad de midudev: [https://codember.dev/mecenas.json](https://codember.dev/mecenas.json)
